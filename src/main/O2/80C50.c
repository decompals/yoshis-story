...
void func_800800CC(MtxF* mfA, MtxF* mfB) {
    ...
    tempW = mfA->mf[3][0];
    mfA->mf[0][0] =
        (mfB->mf[0][0] * tempX) + (mfB->mf[0][1] * tempY) + (mfB->mf[0][2] * tempZ) + (mfB->mf[0][3] * tempW);
    mfA->mf[1][0] =
        (mfB->mf[1][0] * tempX) + (mfB->mf[1][1] * tempY) + (mfB->mf[1][2] * tempZ) + (mfB->mf[1][3] * tempW);
    mfA->mf[2][0] =
        (mfB->mf[2][0] * tempX) + (mfB->mf[2][1] * tempY) + (mfB->mf[2][2] * tempZ) + (mfB->mf[2][3] * tempW);
    mfA->mf[3][0] =
        (mfB->mf[3][0] * tempX) + (mfB->mf[3][1] * tempY) + (mfB->mf[3][2] * tempZ) + (mfB->mf[3][3] * tempW);
...
#pragma GLOBAL_ASM("asm/us/nonmatchings/main/O2/80C50/func_80080914.s")
